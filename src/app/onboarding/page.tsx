  ...
  useEffect(() => {
    const checkUser = async () => {
      ...
      if (profile?.first_name && profile?.locality) {
        // If already completed, skip to map
          ...
          <div key="step2" className="step-fade-in">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', textAlign: 'left' }}>
               <input 
                 ...
                 autoFocus
               />
               <p style={{ fontSize: '0.85rem', color: '#999', padding: '0 1rem', lineHeight: '1.4' }}>No te preocupes, podés moverte por todo el mapa después. Solo es para empezar.</p>
