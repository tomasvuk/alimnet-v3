          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '3rem', alignItems: 'stretch' }}>
            ...
            >
              ...
              <button 
                ...
                style={{ width: '100%', borderRadius: '16px', padding: '1rem', fontWeight: '950', background: 'var(--text-secondary)', border: 'none', color: 'white', cursor: 'pointer' }}
              >
                Invitar café
              </button>
            </div>
            ...
            <div 
                style={{ 
                    ...
                    transform: 'scale(1.05)', zIndex: 10, cursor: 'pointer'
                }} 
