...
import { 
  Heart, Coffee, Sparkles, ShieldCheck, Mail, ArrowRight, Instagram, Linkedin 
} from 'lucide-react';
  ...
  return (
    <div style={{ 
      ...
      <main style={{ 
          ...
          <div style={{ 
            ...
            <div 
                style={{ 
                    ...
                    boxShadow: '0 20px 40px rgba(0,0,0,0.02)', transition: 'all 0.4s ease', cursor: 'pointer'
                }} 
        ...
        {/* MOTOR DE COBRO DINÁMICO REFINADO (SLIM) */}
        <AnimatePresence>
            {initialFreq && (
                <motion.div 
                    ref={hubRef}
                ...
                >
                    <div style={{ background: 'white', padding: 'clamp(2rem, 5vw, 4rem)', borderRadius: '48px', border: '1.5px solid #E4EBDD', boxShadow: '0 40px 100px rgba(0,0,0,0.04)', maxWidth: '550px', width: '100%' }}>
        ...
        {/* ACCIÓN COMUNITARIA (SLIM benefits) */}
        <div style={{ 
          ...
          border: '1.5px solid #E4EBDD' 
           ...
           <div className="action-grid" style={{ 
             ...
             {/* PILARES REFINADOS (SLIM benefits) */}
        ...
        {/* QUIENES ESTÁN DETRÁS (SLIM version) */}
          ...
          <div className="founder-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '3rem', alignItems: 'center' }}>
            <div style={{ textAlign: 'center' }}>
               <div style={{ 
                 ...
                 <img 
                    src="https://alimnet-v3.vercel.app/tomas.jpg" 
                    alt="Tomas Vukojicic" 
