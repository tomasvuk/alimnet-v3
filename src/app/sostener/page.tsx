...
import { Leaf, Heart, ShieldCheck, Users, User, ArrowRight, Mail, Coffee, Instagram, Linkedin } from 'lucide-react';
    ...
    <div style={{ minHeight: '100vh', background: 'var(--background)', color: 'var(--text-primary)' }}>
      ...
      <header style={{ padding: '1.5rem 2rem', background: 'white', borderBottom: '1px solid var(--border)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', position: 'sticky', top: 0, zIndex: 100 }}>
        ...
        <button 
          ...
          style={{ background: 'none', border: '1px solid var(--primary)', color: 'var(--primary)', padding: '0.6rem 1.2rem', borderRadius: '12px', fontWeight: '800', cursor: 'pointer' }}
        >
          Volver al Mapa
        </button>
      </header>
      ...
      <main style={{ maxWidth: '1000px', margin: '0 auto', padding: '6rem 2rem' }}>
        ...
        <div style={{ marginBottom: '6rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '2rem' }}>
            <div style={{ background: 'white', padding: '3rem', borderRadius: '40px', border: '1px solid var(--border)', boxShadow: 'var(--shadow-lg)', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
              ...
              <button className="button button-primary" style={{ width: '100%', borderRadius: '14px', padding: '1rem', fontWeight: '950' }}>Invitar un café (Cafecito)</button>
            </div>

            <div style={{ 
              background: 'linear-gradient(135deg, #1A2419 0%, #3D4F37 100%)', 
              padding: '3.5rem', borderRadius: '40px', color: 'white', position: 'relative', overflow: 'hidden',
              boxShadow: '0 25px 50px rgba(45, 58, 38, 0.25)', border: '1px solid rgba(255,255,255,0.1)'
            }}>
              <div style={{ position: 'absolute', top: '20px', right: '20px', background: 'var(--primary)', color: 'white', padding: '0.4rem 1rem', borderRadius: '20px', fontSize: '0.7rem', fontWeight: '950', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Recomendado</div>
              ...
              <h3 style={{ fontSize: '1.8rem', fontWeight: '950', marginBottom: '1rem', letterSpacing: '-0.02em', color: '#FFFFFF' }}>Miembro Fundador</h3>
              <p style={{ color: 'rgba(255,255,255,0.9)', fontSize: '1rem', lineHeight: '1.6', marginBottom: '2.5rem', fontWeight: '500' }}>
                Además del tiempo dedicado, existen diversos costos fijos tecnológicos para sostener la red. Tu aporte mensual nos permite tener un equipo dedicado a la mejora continua de esta comunidad.
              </p>
              <button style={{ 
                width: '100%', borderRadius: '18px', padding: '1.2rem', background: 'white', color: '#1A2419', 
                border: 'none', fontWeight: '1000', cursor: 'pointer', fontSize: '1.1rem', transition: 'transform 0.2s',
        ...
        <div style={{ marginBottom: '6rem', padding: '0 2rem' }}>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '4rem', alignItems: 'center' }}>
            <div style={{ 
              ...
              boxShadow: `
                12px 12px 25px rgba(45, 58, 38, 0.15), 
