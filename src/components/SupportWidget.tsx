        ...
        <div style={{ ...chatWindow, width: isMobile ? '280px' : '320px' }}>
          <div style={chatHeader}>
             <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <span style={{ fontWeight: '900', fontSize: '0.8rem', color: '#657D51', textTransform: 'uppercase' }}>Alimnet Support <span style={{ fontSize: '10px', fontWeight: '800', opacity: 0.5 }}>v4.1.7-ESFERA-SOLA ✨</span></span>
             </div>
